	...
	return (
					...
					<List className={'sub-section'}>
						{user.memberType === 'AGENT' && (
							<>
								...
								<ListItem className={pathname === 'addBooking' ? 'focus' : ''}>
									<Link
										href={{
											pathname: '/mypage',
											query: { category: 'addBooking' },
										}}
										scroll={false}
									>
										<div className={'flex-box'}>
								...
								<ListItem className={pathname === 'myBookings' ? 'focus' : ''}>
									<Link
										href={{
											pathname: '/mypage',
		...
		S264.354,296.75,223,296.75z"
				...
				<Stack className={'section'} sx={{ marginTop: '30px' }}>
					...
					<List className={'sub-section'} sx={{ marginTop: '10px' }}>
						<ListItem className={pathname === 'myProfile' ? 'focus' : ''} sx={{ color: 'white' }}>
							<Link
								href={{
									pathname: '/mypage',
